...
Tout graphe à n sommets a au maximum 3n/3 cliques maximales, et le temps d'exécution le plus défavorable de l'algorithme de Bron-Kerbosch (avec une stratégie pivot qui minimise le nombre d'appels récursifs effectués à chaque étape) est $O(3n/3)$, correspondant à cette limite.
...
Au debut, nous créons I $O(N)$, choisissons un sommet 
